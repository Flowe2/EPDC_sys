<template>
  <div class="aboutBody">
    <h1 class="aboutH1">THIS IS ABOUT PAGE</h1>
    <svg
      id="approved"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 650.6 650.6"
    >
      <circle class="st0" cx="325.3" cy="325.3" r="323.3" />
      <path
        class="st1"
        d="M96.9 274.5l6.1 11.1 11.2 6.1-11.2 6.2-6.1 11.1-6.1-11.1-11.2-6.2 11.2-6.1z"
      />
      ...
      <g class="rocket">
        <path
          d="M325.3 62s110.9 201.8 19.3 405l-9.6 25.7h-19.3l-9.6-25.7c-91.7-203.1 19.2-405 19.2-405z"
          fill="#fa3757"
          stroke="#13192d"
          stroke-width="4"
        ...
        <path
          class="st3"
          d="M344.5 467.1l-9.6 25.7h-19.2l-9.6-25.7c12.2 2.8 25.1 2.6 38.4 0zM359.2 149.6c-15.6-53.8-34-87.6-34-87.6s-18.3 33.5-33.8 86.9c19.5 6.6 42.8 5.5 67.8.7zM277.1 375s50.5 6.8 96.3 0l-3.7 17.6s-44.5 5.4-88.9 0l-3.7-17.6zM282.8 400.3s45.6 5.8 84.9 0l-4.3 15.1s-38.1 4.6-76.3 0l-4.3-15.1z"
        />
        <path
          class="st3"
...
<style scoped>
@import '../assets/stylesheets/AboutAnimation.css';
...
#approved {
  ...
  border-radius: 50%;
  animation: rocketShake 0.1s linear alternate infinite;
}
#approved {
  clip-path: circle(at center);
  border: 4px solid #f8f3dc;
